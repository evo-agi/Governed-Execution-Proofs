...
- Codex-reported deterministic IM validation exists.
...
- IM evidence remains diagnostics/provenance, not CP or ES authority.
...
status. The deterministic and limited provenance notes below are separate from
the static example.
